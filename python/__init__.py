...
'''
This is the GNU Radio MIMO_OFDM_JRC module. Place your Python package
...
# import swig generated symbols into the mimo_ofdm_jrc namespace
try:
    # this might fail if the module is python-only
    from .mimo_ofdm_jrc_swig import *
