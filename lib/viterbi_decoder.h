 ...
 */
#ifndef INCLUDED_MIMO_OFDM_JRC_VITERBI_DECODER_H
#define INCLUDED_MIMO_OFDM_JRC_VITERBI_DECODER_H
	...
	#define TRACEBACK_MAX 24
		...
		*/
		...
		public:
			...
			viterbi_decoder();
            void reset_store_pos();

			virtual ~viterbi_decoder();

			uint8_t* decode(ofdm_mcs *ofdm, packet_param *burst, uint8_t *in);
